...
public class VehicleManagementController {
	...
	@Value("${todays.vehicle.fare}")
	private String todaysVehicleFare;
	
	//@RequestMapping(value="/addVehicle",method=RequestMethod.POST)
	@PostMapping("/vehicle")
	public List<VehicleBean> addVehicle(@Valid @RequestBody VehicleBean vbean) throws VehicleServiceException {
		log.info("Todays Vehicle fare is {}",todaysVehicleFare);
	...
	public  List<VehicleBean> deleteVehicle(@PathVariable("vehicleId") String vehicleId) throws VehicleServiceException {
	...
	public  VehicleBean editVehicle(@PathVariable("vehicleId") String vehicleId) throws VehicleServiceException {
		log.info("Todays Vehicle fare is {}",todaysVehicleFare);
		System.out.println("i am in delete vehicle:\t"+vehicleId);
	...
	@PutMapping("/vehicle")
	public  List<VehicleBean> updateVehicle(@RequestBody VehicleBean vbean) throws VehicleServiceException {
	...
	@GetMapping("/vehicle")
	public  List<VehicleBean> findAllVehicle() throws VehicleServiceException {
		List<VehicleBean> vbeanList = vehicleService.findAll();
