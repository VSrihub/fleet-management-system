...
<head>
  ...
  <title>Add Vehicle |Razes Fleet Management</title>
 ...
 <!-- container section start -->
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Razes  <span class="lite">Fleet Management</span></a>
      <!--logo end-->
 ...
 <span>Inc&Exp</span>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><img src="img/car.png"> <strong>Add Vehicle</h3></strong>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li> <img src="img/car.png"></i>Vehicle</li>
              <li></i>Add Vehicle</li>
            </ol>
          </div>
        </div>
  ...
  <div class="container">
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="v_chassis_no" value="" class="form-control" placeholder="Chassis No">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Engine No</label>
                        <input type="text" name="v_engine_no" value="" class="form-control" placeholder="Engine No">
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Manufactured By</label>
                        <input type="text" name="v_manufactured_by" value="" class="form-control" placeholder="Manufactured By">
                      </div>
                    </div>
                    </div>
                    <hr>
