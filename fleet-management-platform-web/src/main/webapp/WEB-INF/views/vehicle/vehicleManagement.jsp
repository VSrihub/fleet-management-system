...
<i class="fa fa-users" aria-hidden="true"></i>
 ...
 <span>Inc&Exp</span>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"> <img src="img/car.png"></img><strong>Vehicle Management</strong></h3>
            <ol class="breadcrumb">
              ...
              strong{
                color:black;
                    ...
                    <div class="text-right">
                      <div class="btn">
                     <a href="./vehicle/addView" class="btn btn-primary btn-sm" >Add New Vehicle</a>
                      </header>
                     </div>
 ...
 <td>
 <a href="Add Vehicle.html" class="btn btn-info btn-sm">
