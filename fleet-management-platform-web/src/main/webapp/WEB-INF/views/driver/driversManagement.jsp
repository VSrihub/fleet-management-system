...
<head>
  ...
  <title>Drivers management|Naresh IT Fleet Management</title>
 ...
 <span>Inc&Exp</span>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><img src="img/dr.png"></img></img>Drivers Management</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li> <img src="img/dr.png"></i>Drivers</li>
              <li></i>Drivers Management</li>
            </ol>
          </div>
...
<div class="row">
          <div class="col-lg-12">
            ...
            <h3> <strong> List of Drivers</strong></h3>
               <div class="text-right">
                      <div class="btn">
                     <a href="Add Driver.html" class="btn btn-primary btn-sm" >Add New Driver</a>
              </header>
              <br>
              ...
              <table class="table table-striped table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_mobile"></i> Mobile</th>
                     <th><i class="icon_pin_alt"></i>Address</th>
                      <th><i class="icon_id"></i> License No</th>
                       <th><i class="icon_calendar"></i> License exp date</th>
                      <th><i class="icon_calendar"></i> Date of joining</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="Add Driver.html"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-success" href="Add Driver.html"><i class="icon_check_alt2"></i></a>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="Add Driver.html"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                  <tr>
